...
const donations: [string, string, string, string][] = [
  [
    "Amazon Reforestation Unit",
    "Community trees planted · Aug 28, 2024",
    "$500.00",
    "COMPLETED",
  ],
  [
    "Sahara Solar Initiative",
    "Community solar panels · Aug 15, 2024",
    "$1,200.00",
    "COMPLETED",
  ],
  [
    "Ocean Plastic Cleanup",
    "Ocean waste collected · Jul 22, 2024",
    "$250.00",
    "COMPLETED",
  ],
  [
    "Wind Farm Expansion",
    "Clean energy expansion · Jul 09, 2024",
    "$100.00",
    "COMPLETED",
  ],
];
      ...
      <PageContainer>
        ...
        <div className="mt-6 rounded-[24px] bg-white p-4 shadow-[0_12px_30px_rgba(43,91,58,.08)]">
          <div className="flex items-center gap-3 rounded-xl bg-[#f2faf3] px-4">
            ...
            />
            <span className="hidden rounded-full bg-[#087532] px-4 py-2 text-xs font-bold text-white sm:block">
              All time
            </span>
          </div>

          <div className="mt-4 divide-y divide-[#edf3ee]">
            {donations.map(([name, desc, amount, status]) => (
              <div
                key={name}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-[#718077]">{desc}</p>
                </div>
                <div className="text-left sm:text-right">
                  <p className="font-extrabold">{amount}</p>
                  <p className="text-[10px] font-bold tracking-wider text-[#159449]">
                    {status}
                  </p>
                </div>
              </div>
